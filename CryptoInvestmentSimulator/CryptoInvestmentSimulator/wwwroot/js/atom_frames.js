...
// Loads all cosmos charts, adds a refresh interval and switch buttons
window.addEventListener("load", (event) => {
	$('#chartZone1h').load("/Market/ATOM1hChart");
	setInterval(function () { $('#chartZone1h').load("/Market/ATOM1hChart"); }, 60000);
	document.getElementById("chartZone1h").style.display = "block";

	$('#chartZone4h').load("/Market/ATOM4hChart");
	setInterval(function () { $('#chartZone4h').load("/Market/ATOM4hChart"); }, 60250);
	document.getElementById("chartZone4h").style.display = "none";

	$('#chartZone8h').load("/Market/ATOM8hChart");
	setInterval(function () { $('#chartZone8h').load("/Market/ATOM8hChart"); }, 60500);
	document.getElementById("chartZone8h").style.display = "none";

	$('#chartZone24h').load("/Market/ATOM24hChart");
	setInterval(function () { $('#chartZone24h').load("/Market/ATOM24hChart"); }, 60750);
