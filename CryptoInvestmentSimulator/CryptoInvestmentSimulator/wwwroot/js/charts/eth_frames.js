...
// Loads all Etherium chart partial views in designated chartZone divs.
...
{
	$('#chartZone1h').load("/Market/ETH1hChart");
	setInterval(function () { $('#chartZone1h').load("/Market/ETH1hChart"); }, 60000);
	document.getElementById("chartZone1h").style.display = "block";

	$('#chartZone4h').load("/Market/ETH4hChart");
	setInterval(function () { $('#chartZone4h').load("/Market/ETH4hChart"); }, 60250);
	document.getElementById("chartZone4h").style.display = "none";

	$('#chartZone8h').load("/Market/ETH8hChart");
	setInterval(function () { $('#chartZone8h').load("/Market/ETH8hChart"); }, 60500);
	document.getElementById("chartZone8h").style.display = "none";

	$('#chartZone24h').load("/Market/ETH24hChart");
	setInterval(function () { $('#chartZone24h').load("/Market/ETH24hChart"); }, 60750);
	...
	$('#activePositionZone').load("/Market/PositionsTableETH");
	setInterval(function () { $('#activePositionZone').load("/Market/PositionsTableETH"); }, 61000);
});
